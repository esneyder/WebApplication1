                ...
                <div class="col-lg-12">
                  ...
                  Codigo Estudiantil *
                        ...
                        <tr>
                            ...
                            <td class="auto-style4">
                                <asp:TextBox ID="txtFechaNacimiento" runat="server" CssClass="form-control" Width="171px" TextMode="Date"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="auto-style4">
                                <asp:DropDownList ID="ddlCiudad" CssClass="form-control" runat="server" Height="29px" Width="185px" DataSourceID="ciudad" DataTextField="ciudad" DataValueField="idCiudad">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td class="auto-style6">
                                <asp:DropDownList ID="dllFacultad" runat="server" CssClass="form-control" Height="29px" Width="185px" DataSourceID="facultad" DataTextField="facultad" DataValueField="idFacultad">
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td class="auto-style7">
                                <asp:DropDownList ID="ddlPrograma" runat="server" Height="31px" CssClass="form-control" Width="185px" DataSourceID="programa" DataTextField="programa" DataValueField="idPrograma">
                                </asp:DropDownList>
